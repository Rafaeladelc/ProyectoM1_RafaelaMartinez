...
forma rápida e intuitiva, mostrando cada color junto a su código HEX para
usarlo directamente en propuestas visuales.

## 🚀 Demo

_(pendiente — enlace de GitHub Pages)_
...
- [X] Microfeedback visible al interactuar
